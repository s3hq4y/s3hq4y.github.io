...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var ee={name:t,shader:n},r=`prePassDeclaration`,i=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a={name:r,shader:i},o=`oitDeclaration`,s=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var ne={name:c,shader:l},u=`ltcHelperFunctions`,d=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var re={name:p,shader:m},h=`shadowsFragmentFunctions`,g=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var ie={name:x,shader:S},C=`imageProcessingDeclaration`,w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var T={name:C,shader:w},E=`imageProcessingFunctions`,D=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var O={name:E,shader:D},k=`textureRepetitionFunctions`,A=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j={name:k,shader:A},M=`bumpFragmentMainFunctions`,N=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var ae={name:M,shader:N},P=`bumpFragmentFunctions`,F=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var oe={name:P,shader:F},I=`bumpFragment`,L=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var R={name:I,shader:L},z=`decalFragment`,B=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var V={name:z,shader:B},H=`depthPrePass`,U=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var W={name:H,shader:U},G=`lightFragment`,K=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=K);var se={name:G,shader:K},q=`logDepthFragment`,J=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=J);var ce={name:q,shader:J},Y=`meshBlendTagFragmentOutput`,X=`#if SCENE_MRT_COUNT>{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=X);var le={name:Y,shader:X},Z=`oitFragment`,Q=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=Q);var $={name:Z,shader:Q};export{f as _,W as a,a as b,oe as c,O as d,T as f,re as g,_ as h,se as i,ae as l,b as m,le as n,V as o,ie as p,ce as r,R as s,$ as t,j as u,ne as v,ee as x,te as y};