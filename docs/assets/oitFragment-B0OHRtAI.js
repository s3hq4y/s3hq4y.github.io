...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var ee={name:t,shader:n},r=`objectIdFunctions`,i=`highp vec4 encodeObjectId(highp float objectId) {
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var te={name:o,shader:s},c=`oitDeclaration`,l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var ie={name:x,shader:S},C=`samplerFragmentDeclaration`,w=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var ae={name:C,shader:w},T=`reflectionFunction`,E=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D={name:T,shader:E},O=`imageProcessingDeclaration`,k=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var A={name:O,shader:k},j=`imageProcessingFunctions`,M=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var oe={name:j,shader:M},N=`textureRepetitionFunctions`,P=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var se={name:N,shader:P},F=`bumpFragmentMainFunctions`,I=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var ce={name:F,shader:I},L=`bumpFragmentFunctions`,R=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z={name:L,shader:R},B=`bumpFragment`,V=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var H={name:B,shader:V},U=`decalFragment`,W=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var le={name:U,shader:W},G=`depthPrePass`,K=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=K);var ue={name:G,shader:K},q=`lightFragment`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);var de={name:q,shader:J},Y=`logDepthFragment`,X=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=X);var Z={name:Y,shader:X},Q=`oitFragment`,$=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=$);var fe={name:Q,shader:$};export{ee as S,re as _,le as a,te as b,ce as c,A as d,D as f,_ as g,b as h,ue as i,se as l,ie as m,Z as n,H as o,ae as p,de as r,z as s,fe as t,oe as u,f as v,a as x,ne as y};