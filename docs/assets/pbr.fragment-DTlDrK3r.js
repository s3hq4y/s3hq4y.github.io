import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as te,t as ne}from"./fogFragment-CISE_m3s.js";import{S as re,_ as ie,a as ae,b as oe,c as se,d as ce,f as le,g as ue,h as de,i as fe,l as pe,m as me,n as he,o as ge,p as _e,r as ve,s as ye,t as be,u as xe,v as Se,x as Ce,y as we}from"./oitFragment-B0OHRtAI.js";import{i as Te,n as Ee,r as De,t as Oe}from"./logDepthDeclaration-ZzJ0cRAm.js";import{t as ke}from"./helperFunctions-gEnZbjN3.js";import{n as Ae,r as je,t as Me}from"./pbrBRDFFunctions-CEzBqTfa.js";var n=`pbrFragmentDeclaration`,Ne=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=Ne);var Pe={name:n,shader:Ne},r=`pbrFragmentExtraDeclaration`,Fe=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=Fe);var Ie={name:r,shader:Fe},i=`samplerFragmentAlternateDeclaration`,Le=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=Le);var Re={name:i,shader:Le},a=`pbrFragmentReflectionDeclaration`,o=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var ze={name:a,shader:o},s=`pbrFragmentSamplersDeclaration`,c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var Be={name:s,shader:c},l=`subSurfaceScatteringFunctions`,u=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var Ve={name:l,shader:u},d=`importanceSampling`,f=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var He={name:d,shader:f},p=`pbrHelperFunctions`,m=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var Ue={name:p,shader:m},h=`pbrDirectLightingSetupFunctions`,g=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var We={name:h,shader:g},_=`pbrDirectLightingFalloffFunctions`,v=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var Ge={name:_,shader:v},y=`hdrFilteringFunctions`,b=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var Ke={name:y,shader:b},x=`pbrDirectLightingFunctions`,S=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var qe={name:x,shader:S},C=`pbrIBLFunctions`,w=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var Je={name:C,shader:w},T=`pbrBlockAlbedoOpacity`,E=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var Ye={name:T,shader:E},D=`pbrBlockReflectivity`,O=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var Xe={name:D,shader:O},k=`pbrBlockAmbientOcclusion`,A=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var Ze={name:k,shader:A},j=`pbrBlockAlphaFresnel`,Qe=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=Qe);var $e={name:j,shader:Qe},M=`pbrBlockAnisotropic`,et=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=et);var tt={name:M,shader:et},N=`pbrBlockReflection`,nt=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=nt);var rt={name:N,shader:nt},P=`pbrBlockSheen`,it=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=it);var at={name:P,shader:it},F=`pbrBlockClearcoat`,I=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var ot={name:F,shader:I},L=`pbrBlockIridescence`,st=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=st);var ct={name:L,shader:st},R=`pbrBlockSubSurface`,lt=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=lt);var ut={name:R,shader:lt},z=`pbrBlockReflectance0`,dt=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=dt);var ft={name:z,shader:dt},B=`pbrClusteredLightingFunctions`,pt=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=pt);var mt={name:B,shader:pt},V=`pbrBlockNormalGeometric`,ht=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=ht);var gt={name:V,shader:ht},H=`pbrBlockNormalFinal`,_t=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=_t);var vt={name:H,shader:_t},U=`pbrBlockLightmapInit`,yt=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=yt);var bt={name:U,shader:yt},W=`pbrBlockGeometryInfo`,xt=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=xt);var St={name:W,shader:xt},G=`pbrBlockReflectance`,Ct=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=Ct);var wt={name:G,shader:Ct},K=`pbrBlockDirectLighting`,Tt=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=Tt);var Et={name:K,shader:Tt},q=`pbrBlockFinalLitComponents`,Dt=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Dt);var Ot={name:q,shader:Dt},J=`pbrBlockFinalUnlitComponents`,kt=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=kt);var At={name:J,shader:kt},Y=`pbrBlockFinalColorComposition`,jt=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=jt);var Mt={name:Y,shader:jt},X=`pbrBlockImageProcessing`,Nt=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Nt);var Pt={name:X,shader:Nt},Z=`pbrBlockPrePass`,Ft=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=Ft);var It={name:Z,shader:Ft},Q=`pbrDebug`,Lt=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=Lt);var Rt={name:Q,shader:Lt},$=`pbrPixelShader`,zt=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[$]||(e.ShadersStore[$]=zt);var Bt=[Ce,oe,we,re,Pe,Te,De,je,Ee,Ie,Se,ie,_e,Re,ze,Be,ce,t,Oe,te,pe,ke,Ve,He,Ue,xe,me,Ae,ue,We,Ge,Me,Ke,qe,Je,se,ye,le,ae,Ye,Xe,Ze,$e,tt,rt,at,ot,ct,ut,de,ft,mt,ee,gt,ge,vt,fe,bt,St,wt,Et,ve,Ot,At,Mt,he,ne,Pt,It,be,Rt];for(let t of Bt)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Vt={name:$,shader:zt};export{Vt as pbrPixelShader};