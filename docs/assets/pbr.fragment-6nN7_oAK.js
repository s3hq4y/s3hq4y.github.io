import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-Ct2VqHzk.js";import{n as te,t as ne}from"./fogFragment-EikOP4pH.js";import{i as re,n as ie,r as ae,t as oe}from"./logDepthDeclaration-BFRMqj0n.js";import{_ as se,a as ce,b as le,c as ue,d as de,f as fe,g as pe,h as me,i as he,l as ge,m as _e,n as ve,o as ye,p as be,r as xe,s as Se,t as Ce,u as we,v as Te,x as Ee,y as De}from"./oitFragment-C3tc6CRk.js";import{t as Oe}from"./helperFunctions-BH8P-eyq.js";import{n as ke,r as Ae,t as je}from"./pbrBRDFFunctions-CfZAdMUN.js";var n=`pbrFragmentExtraDeclaration`,Me=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Me);var Ne={name:n,shader:Me},r=`samplerFragmentAlternateDeclaration`,Pe=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=Pe);var Fe={name:r,shader:Pe},i=`pbrFragmentReflectionDeclaration`,Ie=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=Ie);var Le={name:i,shader:Ie},a=`pbrFragmentSamplersDeclaration`,o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var Re={name:a,shader:o},s=`subSurfaceScatteringFunctions`,c=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var ze={name:s,shader:c},l=`importanceSampling`,u=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var Be={name:l,shader:u},d=`pbrHelperFunctions`,f=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var Ve={name:d,shader:f},p=`pbrDirectLightingSetupFunctions`,m=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var He={name:p,shader:m},h=`pbrDirectLightingFalloffFunctions`,g=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var Ue={name:h,shader:g},_=`hdrFilteringFunctions`,v=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var We={name:_,shader:v},y=`pbrBlockReflectance0`,b=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var Ge={name:y,shader:b},x=`pbrClusteredLightingFunctions`,S=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var Ke={name:x,shader:S},C=`pbrDirectLightingFunctions`,w=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var qe={name:C,shader:w},T=`pbrIBLFunctions`,E=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var Je={name:T,shader:E},D=`pbrBlockAlbedoOpacity`,O=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var Ye={name:D,shader:O},k=`pbrBlockReflectivity`,A=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var Xe={name:k,shader:A},j=`pbrBlockAmbientOcclusion`,M=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var Ze={name:j,shader:M},N=`pbrBlockAlphaFresnel`,P=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var Qe={name:N,shader:P},F=`pbrBlockAnisotropic`,$e=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=$e);var et={name:F,shader:$e},I=`pbrBlockReflection`,tt=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=tt);var nt={name:I,shader:tt},L=`pbrBlockSheen`,rt=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=rt);var it={name:L,shader:rt},R=`pbrBlockClearcoat`,at=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=at);var ot={name:R,shader:at},z=`pbrBlockIridescence`,st=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=st);var ct={name:z,shader:st},B=`pbrBlockSubSurface`,lt=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=lt);var ut={name:B,shader:lt},V=`pbrBlockNormalGeometric`,dt=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=dt);var ft={name:V,shader:dt},H=`pbrBlockNormalFinal`,pt=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=pt);var mt={name:H,shader:pt},U=`pbrBlockLightmapInit`,ht=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=ht);var gt={name:U,shader:ht},W=`pbrBlockGeometryInfo`,_t=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=_t);var vt={name:W,shader:_t},G=`pbrBlockReflectance`,yt=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=yt);var bt={name:G,shader:yt},K=`pbrBlockDirectLighting`,xt=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=xt);var St={name:K,shader:xt},q=`pbrBlockFinalLitComponents`,Ct=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=Ct);var wt={name:q,shader:Ct},J=`pbrBlockFinalUnlitComponents`,Tt=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Tt);var Et={name:J,shader:Tt},Y=`pbrBlockFinalColorComposition`,Dt=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=Dt);var Ot={name:Y,shader:Dt},X=`pbrBlockImageProcessing`,kt=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=kt);var At={name:X,shader:kt},Z=`pbrBlockPrePass`,jt=`#if SCENE_MRT_COUNT>0
#ifdef ALPHATEST
...
#endif
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=jt);var Mt={name:Z,shader:jt},Q=`pbrDebug`,Nt=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=Nt);var Pt={name:Q,shader:Nt},$=`pbrPixelShader`,Ft=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[$]||(e.ShadersStoreWGSL[$]=Ft);var It=[Ee,le,De,re,ae,Ae,ie,Ne,Te,_e,Fe,Le,Re,fe,t,oe,te,we,Oe,ze,Be,Ve,de,me,ke,se,He,Ue,je,We,pe,Ge,Ke,qe,Je,ge,ue,be,ye,Ye,Xe,Ze,Qe,et,nt,it,ot,ct,ut,ee,ft,Se,mt,ce,gt,vt,bt,St,he,wt,Et,Ot,xe,ne,At,ve,Mt,Ce,Pt];for(let t of It)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Lt={name:$,shader:Ft};export{Lt as pbrPixelShaderWGSL};